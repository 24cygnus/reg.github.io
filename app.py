...
#         #     request.form.get('Brain Buster', 'NO'),
#         #     request.form.get('Circuit Debugging', 'NO'),
#         #     request.form.get('Clash of minds', 'NO'),
#         #     request.form.get('project expo', 'NO'),
#         #     request.form.get('Food Feast', 'NO'),
#         #     request.form.get('HallOfWar', 'NO'),
#         #     request.form.get('Photography', 'NO'),
#         #     request.form.get('Dance', 'NO'),
#         #     request.form.get('Singing', 'NO'),
#         #     request.form.get('Silambam', 'NO'),
#         #     request.form['upiId'],
